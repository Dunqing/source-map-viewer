// @ts-nocheck — standalone script, run via `npx tsx`, not part of the project build
/**
 ...
 *   npm i -g oxc-transform rolldown tsx
 *
 * The script writes `src/examples/generated.json` which is imported by
 * `src/examples/index.ts`.  Re-run whenever you upgrade a transformer.
 */
...
function generateAll() {
  ...
  output += `// Re-run: npx tsx scripts/generate-examples.ts\n\n`;
